...
def get_page_rules(rules_raw: List[str]) -> PageRules:
  page_rules: PageRules = defaultdict(set) # Value is set of pages that CAN'T appear after key
...
def get_middle_page_number_of_corrected_updates(update: List[str], page_rules: PageRules) -> int:
