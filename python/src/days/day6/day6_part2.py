...
class Map:
    ...
    def check_for_loops(self) -> bool:
        while True:
            ...
            self.positions[self.current_position[0]][
                self.current_position[1]
            ].directions_visited.add(self.direction)
    ...
    def current_position_already_visited(self) -> bool:
        current_cell = self.positions[self.current_position[0]][
            self.current_position[1]
        ]
    ...
    with open(filepath, "r") as file:
        ...
        for i, row in enumerate(positions):
            ...
            for j, val in enumerate(row):
                ...
                # add an obstacle
                new_positions[i] = (
                    new_positions[i][:j] + "#" + new_positions[i][j + 1 :]
                )
